...
class StreamingParityTests(StreamingTestsMixin, ReusedConnectTestCase):
    # TODO: is this true?
    @unittest.skip("streaming UDFs are not supported yet Spark Connect, should enable later.")
    def test_stream_status_and_progress(self):
        super().test_stream_status_and_progress()

    @unittest.skip("Will be supported with SPARK-43015.")
    ...
    @unittest.skip("Query manager API will be supported later with SPARK-43016.")
